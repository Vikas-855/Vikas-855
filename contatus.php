...
<?php
	if(!empty($_POST['contatform']))
	{
		$fullname=$_POST['fname'];
		$email=$_POST['eaddress'];
		$message=$_POST['message'];
		$query="insert into contatus(fullname,email,message) values('$fullname','$email','$message')";
		if(mysqli_query($connect,$query))
		{
			echo "Contat form saved";
		}
		else
		{
			echo "Contat form not saved";
		}
	}
?>
<!DOCTYPE html>
									...
									<div class="input-information">
										<form method="post">
											<table class=" form">
												...
												<tr>
													<td colspan="3"><input type="submit" name="contatform" value="Save form"></td>
												</tr>
											</table>
										</form>
									</div>
